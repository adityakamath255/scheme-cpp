...
const timing = el<HTMLElement>("timing");
const gutter = el<HTMLElement>("gutter");
...
const b64 = {
  ...
  dec: (b: string) => new TextDecoder().decode(Uint8Array.from(atob(b), c => c.charCodeAt(0))),
};
...
function setSplit(value: string) {
